    ...
    public class CreateAccount : Page
    {
        ...
        */
        ...
        public CreateAccount()
        {
            ...
            Title = new Layouts.Custom.PageTitle("Create an Account", Color.White, Color.Black);
            ...
            FirstNameField.TextEntry.Text = "Mat";
            SurnameField.TextEntry.Text = "Howlett";
            EmailField.TextEntry.Text = "mat@mobiusmedia.co.uk";
            MobileNumberField.TextEntry.Text = "07675623526";
            PasswordField.TextEntry.Text = "Passw0rd323";
