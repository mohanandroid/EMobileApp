...
namespace eCups.e.Composites
{
    public class DragSlider : ActiveComponent
    {
        ...
        StaticLabel BarPointValueLabel;
        ...
        public DragSlider(string title, List<List<string>> barPointValues, int width, int height)
        {
            ...
            Title.Content.FontFamily = Fonts.GetBoldFont();
            ...
            BarPointValueLabel.Content.FontFamily = Fonts.GetRegularFont();
            ...
            SliderObject = new ColourButton(Color.FromHex(Colors.CC_MAIN_ORANGE), Color.Wheat, "", null);
            SliderObject.SetAsDraggable();
            ...
            ForegroundSliderLine = new Grid { Margin = new Thickness(0, (SliderHeight / 2) - 3, (SliderWidth - SliderValue), (SliderHeight / 2) - 3), HeightRequest = 3, WidthRequest = Units.ScreenWidth, BackgroundColor = Color.FromHex(Colors.CC_MAIN_ORANGE) };
